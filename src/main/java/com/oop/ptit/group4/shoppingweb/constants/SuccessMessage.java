...
public class SuccessMessage {
    public static final String LAPTOP_EDITED = "Sản phẩm đã được chỉnh sửa thành công!";
    public static final String LAPTOP_ADDED = "Sản phẩm đã được thêm thành công!";
