...
public class SuccessMessage {
    public static final String MOBILE_PHONE_EDITED = "Số điện thoại đã được chỉnh sửa thành công!";
    public static final String MOBILE_PHONE_ADDED = "Số điện thoại đã được thêm thành công!";
    public static final String PASSWORD_CODE_SEND = "Mã đặt lại mật khẩu đã được gửi tới email của bạn";
